...
final _APIKEY = '96618ac9837e40b3ac1130d06fb08b7f';
...
class NewsService with ChangeNotifier {
  ...
  List<Category> categories = [
    ...
    Category(FontAwesomeIcons.headSideVirus, 'sanar'),
    Category(FontAwesomeIcons.vials, 'ciencia'),
    Category(FontAwesomeIcons.volleyballBall, 'deportes'),
    Category(FontAwesomeIcons.memory, 'tecnología'),
  ];
  ...
  getTopHeadlines() async {
    final url =
        'https://newsapi.org/v2/top-headlines?country=ca&category=business&apiKey=96618ac9837e40b3ac1130d06fb08b7f';
